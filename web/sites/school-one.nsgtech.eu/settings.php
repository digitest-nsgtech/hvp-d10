...
$base_url = 'https://school-one.nsgtech.eu';
...
$databases['default']['default'] = array (
  'database' => 'school1_db',
  'username' => 'school1_user',
  'password' => 'school1_pass',
  'prefix' => '',
  'host' => '10.0.0.2',
  'port' => '3306',
...
/*
/ BEFORE you set any $config values:
$settings['s3fs.access_key'] = 'd1bc27863cb8bdee9e7204900d55a35a';
$settings['s3fs.secret_key'] = 'b54382b9e06474f8a117a7ee1ed3aba0';
// Turn on the wrappers:
$settings['s3fs.use_s3_for_public']  = TRUE;
$settings['s3fs.use_s3_for_private'] = TRUE;

// And—because Contabo’s endpoint isn’t “AWS standard” storage—you usually
// need path-style URLs:
$config['s3fs.settings']['use_path_style_endpoint'] = TRUE;

// rest of S3FS config:
$config['s3fs.settings']['bucket']         = 'drupaltest';
$config['s3fs.settings']['endpoint']       = 'https://eu2.contabostorage.com';
#$config['s3fs.settings']['region']         = 'eu-central-1';
$config['s3fs.settings']['public_folder']  = 'school-one/public';
$config['s3fs.settings']['private_folder'] = 'school-one/private';


// Tell Drupal to use the S3FS wrapper for files:
...
// ——————————————————————————
$config['s3fs.adapters']['school_one_public'] = [
  'bucket'        => 'drupaltest',
...
$config['s3fs.adapters']['school_one_private'] = [
  'bucket'         => 'drupaltest',
  'endpoint'       => 'https://eu2.contabostorage.com',
  'use_https'      => TRUE,
...
// ——————————————————————————
$config['s3fs.settings']['default_public_adapter']  = 'school_one_public';
$config['s3fs.settings']['default_private_adapter'] = 'school_one_private';
...
$config['s3fs.settings']['public_folder'] = 'school-one-public'; // Your public directories in S3 (name of the bucket in minio)
$config['s3fs.settings']['private_folder'] = 'school-one-private'; // Your private directories in S3 (name of the bucket in minio)
*/